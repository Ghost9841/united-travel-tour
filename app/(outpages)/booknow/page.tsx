...
export default function ModernBookNow() {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    // Add travel type to form data
    const formDataWithType = new FormData(form.current);
    formDataWithType.append('travel_type', selectedType);
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              setFormData(prev => ({ ...prev, departure: getNextWeekDate() }));
                            }}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              setFormData(prev => ({ ...prev, return: getTwoWeeksDate() }));
                            }}
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-sm text-blue-600 hover:text-blue-700 font-medium"
                          >
                            2 Weeks
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-3 mt-4">
                            ...
                            <a
                              ...
                              className="px-4 py-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 transition-colors"
                            >
                              ✉️ Email: info@unitedtravels.com
                            </a>
                          </div>
                        </div>
                      </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-blue-600 font-bold text-lg">+44 1234 567890</div>
                  </div>
                </a>
                <a
                  href="mailto:info@unitedtravels.com"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-orange-600 font-bold">info@unitedtravels.com</div>
                  </div>
                </a>
