...
export default function ShareButtons() {
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        onClick={copyLink}
        className="flex items-center gap-2 px-4 py-2 border border-gray-200 hover:text-black rounded-xl text-sm font-medium text-black hover:bg-gray-50 transition-colors"
      >
